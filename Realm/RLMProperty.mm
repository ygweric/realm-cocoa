...
- (void)parseObjcProperty:(objc_property_t)property isSwift:(bool)isSwift readOnly:(bool *)readOnly rawType:(NSString **)rawType {
    unsigned int count;
...
- (instancetype)initSwiftPropertyWithName:(NSString *)name
    ...
    NSString *rawType;
    bool readOnly = false;
    [self parseObjcProperty:property isSwift:true readOnly:&readOnly rawType:&rawType];
    if (readOnly) {
        return nil;
    }
                    ...
                    property:(objc_property_t)property
{
    ...
    [self parseObjcProperty:property isSwift:false readOnly:&isReadOnly rawType:&rawType];
