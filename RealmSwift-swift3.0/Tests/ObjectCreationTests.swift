...
class ObjectCreationTests: TestCase {
    ...
    func testInitWithDictionary() {
        ...
        let baselineValues =
           ["boolCol": true as NSNumber,
            ...
            "binaryCol": "b".data(using: String.Encoding.utf8)! as Data,
    ...
    func testInitWithArray() {
        ...
        let baselineValues = [true, 1, 1.1, 11.1, "b", "b".data(using: String.Encoding.utf8)! as Data,
    ...
    private func validValuesForSwiftObjectType(_ type: PropertyType) -> [AnyObject] {
        ...
        switch type {
            ...
            case .data:     return ["b".data(using: String.Encoding.utf8, allowLossyConversion: false)! as Data]
