...
public final class Realm {
    ...
    /**
     ...
     Disabling `shouldAutorefresh` on a `Realm` without any strong references to it will not have any effect, and
     ...
     the `Realm` that manages them), but it means that setting `shouldAutorefresh = false` in
